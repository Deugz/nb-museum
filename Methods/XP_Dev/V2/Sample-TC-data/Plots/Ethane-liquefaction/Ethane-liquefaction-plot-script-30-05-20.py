...
df = pandas.read_csv('../../Merged/01-02-TC-Merged-07-06-20.xls')
...
plt.title('03-02 Ethane liquefaction ')
plt.axis([1600,4600,90,185])
plt.xlabel('time(s)')
plt.ylabel('Temperature (K)')
ax = fig.gca()
ax.set_xticks(numpy.arange(1600, 4600,300))
ax.set_yticks(numpy.arange(90, 185, 5))
plt.grid()
plt.legend()
plt.show()
