...
#Umatplotlib.use('TkAgg')
#from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2TkAgg
#import tkinter
import matplotlib.pyplot as plt
import pandas

df = pandas.read_csv('../../Merged/01-02-TC-Merged-07-06-20.csv')
...
plt.title('01-02 PID and T setting ')
plt.axis([6600,9000,97,122])
plt.xlabel('time(s)')
plt.ylabel('Temperature (K)')
ax = fig.gca()
ax.set_xticks(numpy.arange(6600, 9000,300))
ax.set_yticks(numpy.arange(97, 122, 1))
plt.grid()
plt.legend()
plt.show()
