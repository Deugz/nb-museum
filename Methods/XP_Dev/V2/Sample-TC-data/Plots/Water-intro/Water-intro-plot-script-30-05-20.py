...
df = pandas.read_csv('../../Merged/09-02-TC-Merged.csv')
...
plt.title('09-02 - Water introduction ')
plt.axis([6000,7320,95,118])
plt.xlabel('time(s)')
plt.ylabel('Temperature (K)')
ax = fig.gca()
ax.set_xticks(numpy.arange(6000, 7320,120))
ax.set_yticks(numpy.arange(95, 118, 1))
plt.grid()
plt.legend()
plt.show()
