...
#plt.plot(time, TC1, 'b-', label = "TC 1 IN bottom")
#plt.plot(time, TC5, 'r-', label = "TC 5 IN top")
#plt.plot(time, TB, 'g-', label = "TB OUT bottom")
plt.plot(time, TC6, 'b-', label = "Thermocouple 4")
...
plt.title('Pebble production ')
plt.axis([13000,17000,88,127])
plt.xlabel('time(s)')
plt.ylabel('Temperature (K)')
ax = fig.gca()
ax.set_xticks(numpy.arange(13000, 17000,300))
ax.set_yticks(numpy.arange(88, 127, 1))
plt.grid()
plt.legend()
plt.show()
