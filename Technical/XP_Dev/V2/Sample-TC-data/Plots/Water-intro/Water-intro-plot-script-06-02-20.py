...
df = pandas.read_csv('../../Merged/02-02-Merged-data.csv')
...
plt.title('02-02 - Water introduction ')
plt.axis([10190,11510,107,127])
plt.xlabel('time(s)')
plt.ylabel('Temperature (K)')
ax = fig.gca()
ax.set_xticks(numpy.arange(10190, 11510,120))
ax.set_yticks(numpy.arange(107, 127, 1))
plt.grid()
plt.legend()
plt.show()
