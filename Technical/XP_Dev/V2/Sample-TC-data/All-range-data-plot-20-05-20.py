...
df = pandas.read_csv('Merged/01-02-TC-Merged-timeupdate.csv')
...
#plt.plot(time, TC1, 'm-', label = "TC 1 ")
#plt.plot(time, TC5, 'g-', label = "TC 2 ")
plt.plot(time2, TA, 'c-', label = "TC A ")
plt.plot(time2, TB, 'b-', label = "TC B ")
#plt.plot(time, TC4, 'r-', label = "TC 3")
#plt.plot(time, TC6, 'y-', label = "TC 4")
...
ax = fig.gca()
ax.set_xticks(numpy.arange(0, 4,1800))
